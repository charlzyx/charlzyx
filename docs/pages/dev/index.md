...
- ~~[nvm-sh/nvm](https://github.com/nvm-sh/nvm)~~ Node Version Manager (已废弃)
- [charlzyx/znvm](https://github.com/charlzyx/znvm) 超快、轻量的 Node 版本管理器（Zig 构建）
- [streamich/git-cz](https://github.com/streamich/git-cz) git Commitizen
- [Zhengqbbb/cz-git](https://Zhengqbbb/cz-git) git Commitizen
- ~~[oh-my-zsh](https://ohmyz.sh/)~~ Unleash your terminal like never before. (已废弃)
- [rossmacarthur/sheldon](https://github.com/rossmacarthur/sheldon) 快速、可配置的 shell 插件管理器
